...
const imageFileInput = document.getElementById('image1');
...
const imageFileInput2 = document.getElementById('image2');
...
const imageFileInput3 = document.getElementById('image3');
imageFileInput3.addEventListener('change', function(event) {
  const file = event.target.files[0];
  const reader = new FileReader();
